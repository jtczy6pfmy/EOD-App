(()=>{
  ...
  /*
    IMPORTANT:
    index.html is the ONLY source of truth for the overall EOD page layout.
    This file must NOT redefine main.app, body, header, sidebar, or the EOD grid.
    It only styles/inserts the TPMS component and installs the TPMS confirmation.
  */
  const css=`
    :root{
      --eod-navy:#001f54;
    ...
    /* TPMS occupies the tpms grid area defined by index.html. */
    .eod-tpms-card{
      grid-area:tpms;
    }
      ...
      <div class="eod-tpms-dialog" role="dialog" aria-modal="true">
        ...
        <div class="eod-tpms-dialog-body">
          ...
          <div class="eod-tpms-warning">
            No TPMS information will be submitted or changed automatically. This is only a confirmation step.
          </div>
