...
(()=>{
  ...
  function installEnterHandlers(){
    const actions={
      tireAuditTotal:"addTireAudits",
      number:"addInspection",
      containerNumber:"addContainerInspection",
      rackNumber:"addRackInspection"
    };
    Object.entries(actions).forEach(([inputId,buttonId])=>{
