(()=>{
  ...
  const css=`
    ...
    /*
      EOD LAYOUT
      Row 1: Terminal / Progress | Chassis
      Row 2: Tire Audits        | Chassis
      Row 3: TPMS across full width
      Row 4: Containers         | Chassis Racks
      Row 5: Comments / Notes across full width
      Row 6: Inspection List across full width
      Row 7: Preview when used
    */
    main.app{
    ...
    /*
      Flatten the sidebar so Terminal and Tire Audits
      can occupy their own grid areas.
    */
    main.app>.sidebar-stack{
      display:contents!important
    }

    main.app>.sidebar-stack>section:nth-child(1){
      grid-area:terminal
    }

    main.app>.sidebar-stack>section:nth-child(2){
      grid-area:tires
    }

    /*
      Direct section order in index.html:
      1 = Chassis
      2 = Containers
      3 = Chassis Racks
      4 = Comments / Notes
      ...
      6 = Preview
    */
    main.app>section:nth-of-type(1){
      grid-area:chassis
    }

    main.app>section:nth-of-type(2){
      grid-area:containers
    }

    main.app>section:nth-of-type(3){
      grid-area:racks
    }

    main.app>section:nth-of-type(4){
      grid-area:notes
    }

    main.app>section:nth-of-type(5){
      grid-area:list
    }

    main.app>section:nth-of-type(6){
      grid-area:preview
    }

    /*
      TPMS card is inserted dynamically immediately
      after the Chassis card.
    */
    .eod-tpms-card{
      grid-area:tpms!important
    }
    ...
    .eod-tpms-card .card-header-styled{
      display:flex;
      align-items:center;
    ...
    .eod-tpms-badge.unlocked{
      background:var(--eod-green)
    }
    ...
    .eod-tpms-dialog-head{
      background:linear-gradient(90deg,var(--eod-navy),var(--eod-navy-2));
      color:#fff;
      padding:14px 16px;
      font-weight:900
    }

    .eod-tpms-dialog-body{
      padding:18px
    }

    .eod-tpms-dialog-body p{
      margin:0 0 14px;
      line-height:1.5;
      color:#334155
    }

    .eod-tpms-dialog-actions{
      display:flex;
      gap:10px;
      margin-top:16px
    }

    .eod-tpms-dialog-actions button{
      flex:1
    }
    ...
    .eod-tpms-confirm{
      background:var(--eod-green)!important;
      color:#fff!important
    }
  ...
  style.id="eod-layout-tpms-style";
  ...
  function makeTpmsCard(){
    ...
    card.innerHTML=`
      ...
      <div class="card-body">
        ...
        <div id="tpmsLoginArea">
          <div class="eod-tpms-grid">
            <div>
              ...
              <input
                ...
                placeholder="Enter TPMS username"
              >
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="Enter TPMS password"
              >
            </div>
          </div>
          ...
          <div class="eod-tpms-lock">
            Credentials are kept only for this browser session and are not saved by this enhancement.
          </div>
        </div>

        <div id="tpmsUnlockedArea" class="eod-tpms-open">

          <div class="eod-tpms-status show">
            ✓ TPMS access unlocked for this session.
          </div>
          ...
          <p class="eod-tpms-note">
            Use the TPMS cloud to pull the chassis data and capture the required screenshot for the work order.
            The EOD app does not automatically submit or change TPMS information.
          </p>
    ...
    if(app){
      app.insertBefore(
        card,
        chassis?.nextElementSibling || null
      );
    }
    ...
    document.getElementById("tpmsOpenCloud")?.addEventListener(
      "click",
      ()=>window.open(
        GOODYEAR_TPMS_URL,
        "_blank",
  ...
  function installTpmsPrompt(){
    ...
    modal.innerHTML=`
      <div class="eod-tpms-dialog" role="dialog" aria-modal="true">
        ...
        <div class="eod-tpms-dialog-head">
          TPMS CHECK REQUIRED
        </div>
        ...
        <div class="eod-tpms-dialog-body">
          ...
          <p>
            Before adding this chassis inspection, confirm that the TPMS information has been checked for this chassis.
          </p>

          <div class="eod-tpms-warning">
            No TPMS information will be submitted or changed automatically.
            This is only a confirmation step.
          </div>

          <div class="eod-tpms-dialog-actions">
            <button class="eod-tpms-cancel" id="tpmsPromptCancel">
              NOT YET
            </button>

            <button class="eod-tpms-confirm" id="tpmsPromptConfirm">
              YES — TPMS CHECKED
            </button>
          </div>
    ...
    modal.querySelector("#tpmsPromptCancel")
      .addEventListener("click",close);

    modal.querySelector("#tpmsPromptConfirm")
